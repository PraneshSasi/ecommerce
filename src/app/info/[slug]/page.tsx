...
const infoData: Record<string, InfoContent> = {
  about: {
    ...
    details: [
      { label: "Corporate Entity", value: "ShopWave India Corp" },
      { label: "Headquarters Address", value: ["123 Indigo Way, Sector 4", "Bangalore, KA 560001", "India"] },
      { label: "Contact Email", value: "corp@shopwave.com" },
  ...
  story: {
    ...
    paragraphs: [
      "ShopWave was founded in 2024 by a team of design enthusiasts and web performance engineers. We were frustrated by slow loading times, cluttered visual layouts, and dark, high-friction checkout flows on mainstream retail sites.",
  ...
  careers: {
    ...
    paragraphs: [
      "At ShopWave, we're always looking for talented developers, designers, and supply chain operators to help scale our high-speed e-commerce platform.",
    ...
    details: [
      ...
      { label: "How to Apply", value: "Send your CV to careers@shopwave.com" }
    ]
  },
  press: {
    title: "Press Relations",
    icon: HelpCircle,
    headline: "ShopWave media resources, updates, and releases.",
    paragraphs: [
      "Get the latest announcements, brand kit resources, and official press releases for ShopWave.",
    ...
    details: [
      { label: "Media Contact", value: "press@shopwave.com" },
  ...
  privacy: {
    ...
    paragraphs: [
      "We respect your privacy. ShopWave does not track your personal details, browsing history, or payment methods outside of what is required to process and dispatch your active order.",
    ...
    details: [
      { label: "Data Controller", value: "ShopWave Security Team" },
  ...
  terms: {
    ...
    icon: FileText,
    headline: "Standard terms and conditions for using ShopWave.",
    paragraphs: [
      "By using the ShopWave storefront, you agree to buy products strictly for personal use. All stock levels, prices, and discounts displayed are active and correct.",
  ...
  help: {
    ...
    details: [
      { label: "Support Ticket Email", value: "support@shopwave.com" },
  ...
  returns: {
    ...
    paragraphs: [
      "Changed your mind? No problem. ShopWave offers a complete 30-day return policy for all unused products in their original packaging.",
      ...
      <div className="rounded-3xl border border-gray-200 bg-white p-6 sm:p-10 shadow-xs space-y-6">
        ...
        {content.details && (
          <div className="border-t border-gray-100 pt-6 mt-6 space-y-4 text-sm">
            <h2 className="font-bold text-gray-900 text-base">Key Details</h2>
            <div className="grid gap-4 sm:grid-cols-2 text-gray-600">
              {content.details.map((detail, idx) => (
                <div key={idx} className="bg-gray-50 rounded-2xl border border-gray-200/50 p-4">
                  <p className="font-bold text-gray-800 mb-1">{detail.label}</p>
